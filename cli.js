...
setTimeout(function () { runBot("BCH", quoteCrypto, "PINGPONG", ticker, "binance", loss1, bougthPrice) }, counter());
...
setTimeout(function () { runBot("BCH", quoteCrypto3, "PINGPONG", ticker, "binance", loss1, bougthPrice) }, counter());
